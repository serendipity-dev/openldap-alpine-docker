...
sed -e "/%CUSTOM_SCHEMAS_INCLUDE%/r /etc/openldap/schemas_ext/schemas_includes.ext" -e "/%CUSTOM_SCHEMAS_INCLUDE%/d" -i "$SLAPD_CONF"
sed -e "/%CUSTOM_ACS_INCLUDE%/r /etc/openldap/acs_ext/acs_includes.ext" -e "/%CUSTOM_ACS_INCLUDE%/d" -i "$SLAPD_CONF"
sed -e "/%CUSTOM_INDEXES_INCLUDE%/r /etc/openldap/indexes_ext/indexes_includes.ext" -e "/%CUSTOM_INDEXES_INCLUDE%/d" -i "$SLAPD_CONF"
